...
class Application:
    ...
    def __init__(self):
        ...
        print("Loaded model from disk")
                ...
                # ================== MAIN WINDOW ==================
        self.root = tk.Tk()
        self.root.title("Sign Language Conversion To Text and speech")
        self.root.protocol('WM_DELETE_WINDOW', self.destructor)
        self.root.geometry("1600x1000")
        self.root.configure(bg="#1E1E2E")

        # ================== CAMERA PANEL ==================
        self.panel = tk.Label(self.root, bg="#2A2A40", bd=2, relief="ridge")
        self.panel.place(x=100, y=3, width=500, height=500)

        # ================== SKELETON PANEL ==================
        self.panel2 = tk.Label(self.root, bg="#2A2A40", bd=2, relief="ridge")
        self.panel2.place(x=750, y=115, width=350, height=350)

        # ================== TITLE ==================
        self.T = tk.Label(
            self.root,
            text="Sign Language Conversion To Text and Speech",
        ...
        self.T.place(relx=0.5, y=20, anchor="n")
